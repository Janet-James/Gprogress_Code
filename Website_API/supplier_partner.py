    ...
    try:
        ...
        if post:
            ...
            if partner_names_str:
                ...
                partner_name_list = [item["value"] for item in partner_names_dict]
                partner_name = ', '.join(map(str, partner_name_list))
            else:
                partner_name = ''

            print("--- PPP --- ",partner_name)
            ...
            if factory_locations:
                factory_locations_dict = json.loads(factory_locations)
                factory_locations_list = [item["value"] for item in factory_locations_dict]
                factory_locations = ', '.join(map(str, factory_locations_list))
            else:
                factory_locations = ''
            print("--- FFF --- ", factory_locations)
            ...
            if warehouse_location_dict_str:
                ...
                warehouse_location_list = [item["value"] for item in warehouse_location_dict]
                warehouse_location = ', '.join(map(str, warehouse_location_list))
            else:
                warehouse_location = ''
            print("--- WWW --- ",warehouse_location)
            ...
            supplied_equipment_yes = post.get("supplied_equipment_yes")
            supplied_equipment_no = post.get("supplied_equipment_no")

            if supplied_equipment_yes:
                supplied_equipment_check = supplied_equipment_yes
            else:
                supplied_equipment_check = supplied_equipment_no

            
            environment_statement_check_val=post.get("environment_statement_check_val")
            human_trafficking_check_val=post.get("human_trafficking_check_val")
            ...
            supplied_agencies = post.get("supplied_agencies")
            env_statement_file_upload = post.get("environment_statement_file_upload[]")
            human_trafficking_certificate= post.get("human_trafficking_certificate_upload[]")
            ...
            supplier_partner_params = {"entityTypeId":136,
                 "fields": {
                     ...
                     # Supplied Equipment 
                     "ufCrm6_1708668304": supplied_equipment_check,
                     ...
                     "ufCrm6_1709192429": supplied_agencies,
                     "ufCrm6_1708666845":already_supplied_meterial_in_png,

                     "ufCrm6_1709281835": env_statement_file_upload,
                     "ufCrm6_1709282039": human_trafficking_certificate,
                     "ufCrm6_1709281745": environment_statement_check_val,
                     "ufCrm6_1709281892": human_trafficking_check_val,               
                }}
