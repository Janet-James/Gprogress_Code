...
urlpatterns = [
   ...
   # path('client/message/reply/<str:entityTypeId>/<str:client_id>/<str:company_id>/', client_partner.Client_Message_Reply.as_view(), name="message_reply"),
    path('client/message/reply/<str:entityTypeId>/<str:client_id>/<str:company_id>/<str:project_id>/', client_partner.Client_Message_Reply.as_view(), name="message_reply"),
    ...
    path('client_partner_temporary_code_check/', client_partner.temporary_code_check, name="client_partner_temporary_code_check"),
    path('update_forgotpassword/', client_partner.update_forgotpassword, name="update_forgotpassword"),
    ...
    # ---- User Activity ----
    path('user_ativity/', client_partner.userActivityLog, name="user_ativity"),
    path('individual_user_log/', client_partner.IndividualUserLog, name="individual_user_log"),

    path('ecommerce/newsletter_subscription/', views.ecommerce_subscribe_news_letter, name="ecommerce_subscribe_news_letter"),
]
