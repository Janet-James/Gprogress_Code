...
/*Tab Panel Active , Resposnive  Menu Script , Sweet Alert, Form Vizard Script */
...
jQuery(document).ready(function () {
	...
	window_height = ((80 * parseInt(window_height)) / 100).toFixed();
	$('#form_wizard_ul').css({
...
/********************* Resposnive view Script****************************/
jQuery('.nav_trigger').click(function () {
	jQuery(this).toggleClass('active');
	jQuery('ul.nav_responsiv').stop().slideToggle(300);
	jQuery('.nav_responsiv ul').slideUp();
	jQuery('.s_arrow').removeClass('close');
});
jQuery('.meals_del_date').click(function () {
	jQuery('.vegan_delivery_by').toggleClass('active');
});
jQuery('.nav_responsiv li .s_arrow').each(function () {
	jQuery(this).click(function () {
		jQuery(this).parent('li').children('ul').stop().slideToggle(300);
		jQuery(this).toggleClass('close');
	});
});
jQuery('.nav_responsiv li a.sa_arrow').each(function () {
	jQuery(this).click(function () {
		jQuery(this).parent('li').children('ul').stop().slideToggle(300);
		jQuery(this).parent('li').children('.s_arrow').toggleClass('close');
	});
});
/************************ End Resposnvie view Script *********************************/


/*********************** Form Vizard Script************************/
function nextStepWizard() {
	$('.hidden_class').addClass('hide_class')
	/*Form Fields Width Change in Vertical Form Wizards during Expand and Collapse MATHI*/
	$('.accordionsub.stage_active').find('.databox').css('width', '100%');
	//$("#btn_info").html('');
	...
	if (btn_change == 1 || btn_change == 0) {
		$("#icon_value").removeClass("fa fa-angle-double-right").addClass("fa fa-angle-double-left");
	} else {
		$("#icon_value").removeClass("fa fa-angle-double-left").addClass("fa fa-angle-double-right");
	}
...
$(document).on('click', '.aw-accordion li.li_lst:not(.stage_active)', function () {
	$('.hidden_class').removeClass('hide_class')
	/*Form Fields Width Change in Vertical Form Wizards during Expand and Collapse MATHI*/
	$('.accordionsub').find('.databox').css('width', '');
	//$("#btn_info").html('');
...
/************************ Sweet Alert Right side top Script ****************************/

(function () {
	$('#basicPrimary').click(function () {
...
/**************************** End Sweet Alert Right side top Script *******************************/
...
$(document).ready(function () {
	var timesClicked = 0;
	$("#usersearch_icon").click(function () {
		$("#usersearch_icon").addClass("icon2");
		$("#usersearch_icon").animate({

			// 'animation': 'slideInRight 2s',
			'right': '15px',
			'transition': 'all .5s cubic-bezier(0.645, 0.575, 0.090,1.000)',
		});
		...
		$(".icon2").click(function () {
			$("#usersearch_icon").animate({
				// 'animation': 'slideInRight 2s',
				'right': '90px',
				'transition': 'all .8s cubic-bezier(0.645, 0.575, 0.090,1.000)',
			});
		...
		if ($('.userprofile_inner').css('display') == 'none') {


			$(".userprofile_inner").css({
				'display': 'block',
				'opacity': ' 1',
				'animation': 'slideInRight 2s',
