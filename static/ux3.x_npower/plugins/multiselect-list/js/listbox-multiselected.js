/* NEXT UX3.0 | Listbox MultiSelect.JS
// Version     -  1.2 
    ...
    a.fn.multi = function(c) {
        ...
        return this.each(function() {
            ...
            if (!c.data("multijs") && c.prop("multiple")) {
                ...
                if (d.enable_search) {
                    var f = a('<input class="search-input" type="text" id="permission_search"/><i class="fa fa-search"></i>').prop("placeholder", d.search_placeholder);
