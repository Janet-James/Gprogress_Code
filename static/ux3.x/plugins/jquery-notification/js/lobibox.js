...
//------------------------------------------------------------------------------
    ...
    Lobibox.alert = function (type, options) {
        if (["success", "error", "warning", "info","primary"].indexOf(type) > -1) {
        ...
        icons: {
            bootstrap: {
                ...
                error: 'glyphicon glyphicon-remove-sign',
				 primary: 'glyphicon glyphicon-remove-sign',
                warning: 'glyphicon glyphicon-exclamation-sign',
                info: 'glyphicon glyphicon-info-sign'
            },
            fontAwesome: {
                confirm: 'nf nf-help-circle',
                success: 'nf nf-check-circle',
				 primary: 'nf nf-check-circle',
                error: 'nf nf-discard-1',
                warning: 'nf nf-exclamation-circle',
                info: 'nf nf-exclamation-circle'
            }
        }
    };
...
//------------------------------------------------------------------------------
    ...
    Lobibox.notify = function (type, options) {
        if (["default", "info", "warning", "error", "primary", "success"].indexOf(type) > -1) {
    ...
    Lobibox.notify.OPTIONS = {
        ...
        icons: {
            bootstrap: {
                success: 'glyphicon glyphicon-ok-sign',
				 primary: 'glyphicon glyphicon-ok-sign',
                error: 'glyphicon glyphicon-remove-sign',
                warning: 'glyphicon glyphicon-exclamation-sign',
                info: 'glyphicon glyphicon-info-sign'
            },
