...
(function (factory) {
    ...
    } else { // no inspection JSUnresolvedVariable
    ...
    // file input helper object for all global variables and internal helper methods
    //no inspection JSUnresolvedVariable
    $h = {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tCaption = '<div tabindex="500" class="nt-forms file-caption {class}">\n' +
            ...
            tActionUpload = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">' +
                '{uploadIcon}</button>';
            tActionZoom = '<span class="kv-file-zoom {zoomClass}" ' +
                'title="{zoomTitle}">{zoomIcon}</span>';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    showZoom: true,
                    showDrag: true,
                    removeIcon: '<i class="fa fa-trash txt-danger"></i>',
                    removeClass: 'ntbtn ntbtn-xsmall ntbtn-default',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="fa fa-upload txt-info"></i>',
                    uploadClass: 'ntbtn ntbtn-xsmall ntbtn-default',
                    uploadTitle: 'Upload file',
                    zoomIcon: '<i class="nf nf-search"></i>',
                    zoomClass: 'file-preview-indicator',
                    zoomTitle: 'Preview',
                    dragIcon: '<i class="fa fa-menu-hamburger"></i>',
                    dragClass: 'text-info',
                    dragTitle: 'Move / Rearrange',
                    dragSettings: {},
                    indicatorNew: '<i class="nf nf-external-link-square txt-warning"></i>',
                    indicatorSuccess: '<i class="fa fa-ok-sign txt-success"></i>',
                    indicatorError: '<i class="fa fa-exclamation-sign text-danger"></i>',
                    indicatorLoading: '<i class="fa fa-hand-up txt-muted"></i>',
                ...
                if (self.previewFileExtSettings) {
                    $.each(self.previewFileExtSettings, function (key, func) {
                        if (self.previewFileIconSettings[key] && func(ext)) {
                            ...
                            //no inspection UnnecessaryReturnStatementJS
                            return;
                        }
                    });
                }
        ...
        _initSortable: function () {
            ...
            //no inspection JSUnusedGlobalSymbols
            settings = {
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            ...
            fullscreen: '<i class="nf nf-change-background"></i> Fullscreen',
            borderless: '<i class="glyphicon glyphicon-resize-full"></i>',
            close: '<i class="fa fa-remove"></i> Close'
        },
        previewZoomButtonClasses: {
            prev: 'ntbtn ntbtn-navigate',
            next: 'ntbtn ntbtn-navigate',
            toggleheader: 'ntbtn ntbtn-default ntbtn-header-toggle',
            fullscreen: 'ntbtn ntbtn-default',
            borderless: 'ntbtn ntbtn-default',
            close: 'ntbtn ntbtn-default'
        },
        ...
        buttonLabelClass: 'secret-xsmall',
        browseIcon: '<i class="nf nf-cloud-upload"></i>&nbsp;',
        browseClass: 'ntbtn ntbtn-blue',
        removeIcon: '<i class="nf nf-discard"></i>',
        removeClass: 'ntbtn ntbtn-default',
        cancelIcon: '<i class="fa fa-ban-circle"></i>',
        cancelClass: 'ntbtn ntbtn-default',
        uploadIcon: '<i class="nf nf-cloud-upload"></i>',
        uploadClass: 'ntbtn ntbtn-default',
        uploadUrl: null,
        uploadAsync: true,
        uploadExtraData: {},
        zoomModalHeight: 480,
