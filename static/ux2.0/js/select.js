/*!
 * select-search v1.6.2 (http://silviomoreto.github.io/select-search/)
 *
 * Copyright 2013-2014 select-search
 * Licensed under MIT (https://github.com/silviomoreto/select-search/blob/master/LICENSE)
 */
! function (a) {
    "use strict";
    ...
    f.VERSION = "1.6.2", f.DEFAULTS = {
        ...
        init: function () {
            ...
            this.$element.hide(), this.multiple = this.$element.prop("multiple"), this.autofocus = this.$element.prop("autofocus"), this.$newElement = this.createView(), this.$element.after(this.$newElement), this.$menu = this.$newElement.find("> .nt-dd-menu"), this.$button = this.$newElement.find("> button"), this.$searchbox = this.$newElement.find("input"), this.options.dropdownAlignRight && this.$menu.addClass("dropdown-menu-right"), "undefined" != typeof c && (this.$button.attr("data-id", c), a('label[for="' + c + '"]').click(function (a) {
        ...
        createDropdown: function () {
            var b = this.multiple ? " show-tick" : "",
                c = this.$element.parent().hasClass("input-set") ? " input-group-btn" : "",
                d = this.autofocus ? " autofocus" : "",
                e = this.$element.parents().hasClass("form-set-large") ? " ntbtn-big" : this.$element.parents().hasClass("form-set-small") ? " ntbtn-small" : "",
                f = this.options.header ? '<div class="popover-title"><button type="button" class="close" aria-hidden="true">&times;</button>' + this.options.header + "</div>" : "",
                g = this.options.liveSearch ? '<div class="bs-searchbox"><input type="text" class="input-block-level nt-forms" autocomplete="off" /></div>' : "",
                h = this.options.actionsBox ? '<div class="bs-actionsbox"><div class="ntbtn-set ntbtn-block"><button class="actions-btn bs-select-all ntbtn ntbtn-small ntbtn-outline">' + this.options.selectAllText + '</button><button class="actions-btn bs-deselect-all ntbtn ntbtn-small ntbtn-outline">' + this.options.deselectAllText + "</button></div></div>" : "",
                i = '<div class="ntbtn-set select-search' + b + c + '"><button type="button" class="ntbtn nt-dd-toggle selectpicker' + e + '" data-toggle="dropdown"' + d + '><span class="filter-option pull-left"></span>&nbsp;<span class="caret"></span></button><div class="nt-dd-menu open">' + f + g + h + '<ul class="nt-dd-menu inner selectpicker" role="menu"></ul></div></div>';
            return a(i)
        },
        createView: function () {
                ...
                if ("" !== l && m && (l = "<span>" + l + "</span>"), c.data("content") || (j = l + '<span class="text">' + j + k + "</span>"), !b.options.hideDisabled || !m)
                    if (c.parent().is("optgroup") && c.data("divider") !== !0) {
                        if (0 === c.index()) {
                            ...
                            o = q + '<span class="text">' + o + p + "</span>", 0 !== n && e.length > 0 && e.push(g("", null, "divider")), e.push(g(o, null, "nt-dd-header"))
                        }
        ...
        liHeight: function () {
            if (this.options.size !== !1) {
                var a = this.$menu.parent().clone().find("> .nt-dd-toggle").prop("autofocus", !1).end().appendTo("body"),
                    b = a.addClass("open").find("> .nt-dd-menu"),
                    c = b.find("li").not(".divider").not(".nt-dd-header").filter(":visible").children("a").outerHeight(),
        ...
        setSize: function () {
            ...
            if (r(), this.options.header && f.css("padding-top", 0), "auto" == this.options.size) {
                var s = function () {
                    ...
                    r(), b = d - q, e.options.dropupAuto && e.$newElement.toggleClass("dropup", c > d && b - q < f.height()), e.$newElement.hasClass("dropup") && (b = c - q), a = h.length + h.filter(".nt-dd-header").length > 3 ? 3 * i + q - 2 : 0, f.css({
                        "max-height": b + "px",
                        overflow: "hidden",
        ...
        selectPosition: function () {
            var b, c, d = this,
                ...
                f = a(e),
                g = function (a) {
                    f.addClass(a.attr("class").replace(/nt-forms/gi, "")).toggleClass("dropup", a.hasClass("dropup")), b = a.offset(), c = a.hasClass("dropup") ? 0 : a[0].offsetHeight, f.css({
                        top: b.top + c,
                        left: b.left,
        ...
        clickListener: function () {
            var b = this;
            this.$newElement.on("touchstart.dropdown", ".nt-dd-menu", function (a) {
                a.stopPropagation()
            }), this.$newElement.on("click", function () {
            ...
            }), this.$menu.on("click", "li.divider, li.nt-dd-header", function (a) {
        ...
        keydown: function (b) {
            ...
            if (o.options.liveSearch && (n = m.parent().parent()), o.options.container && (n = o.$menu), d = a("[role=menu] li a", n), l = o.$menu.parent().hasClass("open"), !l && /([0-9]|[A-z])/.test(String.fromCharCode(b.keyCode)) && (o.options.container ? o.$newElement.trigger("click") : (o.setSize(), o.$menu.parent().addClass("open"), l = !0), o.$searchbox.focus()), o.options.liveSearch && (/(^9$|27)/.test(b.keyCode.toString(10)) && l && 0 === o.$menu.find(".active").length && (b.preventDefault(), o.$menu.parent().removeClass("open"), o.$button.focus()), d = a("[role=menu] li:not(.divider):not(.nt-dd-header):visible", n), m.val() || /(38|40)/.test(b.keyCode.toString(10)) || 0 === d.filter(".active").length && (d = o.$newElement.find("li").filter(o.options.searchAccentInsensitive ? ":aicontains(" + c(p[b.keyCode]) + ")" : ":icontains(" + p[b.keyCode] + ")"))), d.length) {
                ...
                }), e = d.index(d.filter(".active")), g = d.filter(":not(.disabled):visible").first().data("index"), h = d.filter(":not(.disabled):visible").last().data("index"), f = d.eq(e).nextAll(":not(.disabled):visible").eq(0).data("index"), i = d.eq(e).prevAll(":not(.disabled):visible").eq(0).data("index"), j = d.eq(f).prevAll(":not(.disabled):visible").eq(0).data("index")), k = m.data("prevIndex"), 38 == b.keyCode && (o.options.liveSearch && (e -= 1), e != j && e > i && (e = i), g > e && (e = g), e == k && (e = h)), 40 == b.keyCode && (o.options.liveSearch && (e += 1), -1 == e && (e = 0), e != j && f > e && (e = f), e > h && (e = h), e == k && (e = g)), m.data("prevIndex", e), o.options.liveSearch ? (b.preventDefault(), m.is(".nt-dd-toggle") || (d.removeClass("active"), d.eq(e).addClass("active").find("a").focus(), m.focus())) : d.eq(e).focus();
                else if (!m.is("input")) {
                    var q, r, s = [];
                    d.each(function () {
    ...
    }, a(document).data("keycount", 0).on("keydown", ".select-search [data-toggle=dropdown], .select-search [role=menu], .bs-searchbox input", f.prototype.keydown).on("focusin.modal", ".select-search [data-toggle=dropdown], .select-search [role=menu], .bs-searchbox input", function (a) {
        a.stopPropagation()
