/* NEXT UX2.0 | DATE TIME PICKER FOR MOBILE.JS
// Version    0.1 | Build 0.1
// Released on | 11 OCt 2017
...
$.DateTimePicker = $.DateTimePicker || {
	...
	defaults:  //Plugin Defaults
	{
    	...
    	incrementButtonContent: "<i class='nf nf-caret-up'></i>",
    	decrementButtonContent: "<i class='nf nf-caret-down'></i>",
		...
		{			
			if($.cf._isValid(oDTP))
			{
				if(options === "destroy")
				{
					...
					{
						alert_status("No DateTimePicker Object Defined For This Element");
					}
				}
		...
		_setCurrentDate: function()
		{
			...
			if(bGTMaxDate || bLTMinDate)
			{
				...
				else
				{
					...
					alert_status("Please enter proper Date/Time/DateTime values.");
				}
			}
