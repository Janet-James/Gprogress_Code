jQuery(document).ready(function($) {
    ...
    var main_menu = $('.show-menu'),
        ...
        menu_list = ['index.html', 'form_controls.html', 'date_time_pickers.html', 'fileupload.html',
            'tables.html', 'tabs_accordions.html', 'vertical_form_wizard.html', 'talent-matrix.html', 'charts.html','editor.html'
        ];
    ...
    close_main_menu.on('click', function(event) {
		...
		$(".footer_breadcrumb").css("display", "inline-block");
    ...
    function toggleContent(bool) {
        if (bool) {
            ...
            setTimeout(function() {
				...
				$(".footer_breadcrumb").css("display", "none");
    ...
    $(".menu-li").click(function(event) {
        if ($(".menu-li-expand").length == 0) {
            ...
            for (var i = 1; i <= li_count; i++) {
                $("#menu-ull > .i" + i).find("a").removeAttr("href");
                $("#menu-ull > .i" + i).find("a").attr("href", menu_list[i-1]);
            }
            $(".menu-li").addClass("menu-li-expand").removeAttr('style').css({
                'position': 'static',
                'transform': 'none !important',
...
//    $('.carouselctrl').on("mouseover", function () {
////        alert(0)
//    var control = $(this),
//        interval = 500;
//
