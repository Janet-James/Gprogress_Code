...
/*Tab Panel Active , Resposnive  Menu Script , Sweet Alert, Form Vizard Script, Indicator popup script */
...
$('.aw-accordion li').click(function () {
	$("#btn_info").html('');
